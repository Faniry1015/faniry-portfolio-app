                    ...
                    <Grid container spacing={4} sx={{display:'flex', alignItems: 'center', justifyContent: 'center' }} className={`zoom-in ${inView ? 'active' : ''}  `}>
                        ...
                        <Grid item sm={12} md={7} sx={{ marginBottom: 2}}>
                            <Box>
                                ...
                                Hello 👋, je suis Randriaharimino Faniriantsoa, un développeur spécialisé en React.js et Next.js (Javascript), ainsi qu'en Flutter (Dart). Explorez mes projets et plongez dans l'univers des interfaces utilisateur réactives, responsives et cross-platform.
                                </Typography>
                                <Typography sx={{ fontSize: { xs: '16px', sm: '18px', marginBottom: '10px' } }}>
