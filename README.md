...
<h2>Skills</h2>
<ul>
    <li><strong>Basic Languages:</strong> HTML, CSS, JavaScript, Dart, python</li>
    <li><strong>Front-End Frameworks and Libraries</strong> React.js, Material UI, Bootstrap, Leaflet, Flutter</li>
